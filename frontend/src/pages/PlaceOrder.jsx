    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-ful sm:max-w-[480px]'>
          ...
          <div className='flex gap-3'> 
            ...
            <input className='border border-gray-300 rounded py-1.5 px-3 w-full' type="email" placeholder='Enter Eamil'/>
            <input className='border border-gray-300 rounded py-1.5 px-3 w-full' type="text" placeholder='Street'/>
          ...
          <div className='flex gap-3'> 
            ...
            <input className='border border-gray-300 rounded py-1.5 px-3 w-full' type="phone" placeholder='phone'/>
      </div>
        ...
        <div className='mt-12'>
            ...
            <div className='flex gap-3 flex-col lg:flex-row'>
                ...
                <div onClick={()=>setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                    ...
                    <p className='text-gray-500 text-sm font- font-medium mx-4'>CASH ON DELIVERY</p>
                </div>
            </div>
